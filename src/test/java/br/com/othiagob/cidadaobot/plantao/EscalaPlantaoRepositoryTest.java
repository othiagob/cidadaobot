...
class EscalaPlantaoRepositoryTest {
  ...
  void deveSalvarEscalaPlantaoComFarmacia() {
    ...
    assertThat(escalaSalva.getDataPlantao()).isEqualTo(LocalDate.of(2026, 5, 10));
    assertThat(escalaSalva.getIniciaAs()).isEqualTo(LocalTime.of(19, 0));
  ...
  void deveBuscarEscalasPorDataPlantao() {
    ...
    List<EscalaPlantao> resultado =
        escalaPlantaoRepository.findByDataPlantao(LocalDate.of(2026, 5, 10));

    assertThat(resultado).hasSize(1);
    assertThat(resultado.get(0).getFarmacia().getNome()).isEqualTo("Farmácia Central");
    assertThat(resultado.get(0).getDataPlantao()).isEqualTo(LocalDate.of(2026, 5, 10));
  }
  ...
  void naoDeveRetornarEscalaQuandoDataNaoExistir() {
    ...
    List<EscalaPlantao> resultado =
        escalaPlantaoRepository.findByDataPlantao(LocalDate.of(2026, 5, 11));
